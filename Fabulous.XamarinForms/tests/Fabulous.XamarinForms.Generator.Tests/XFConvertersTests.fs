...
module XFConvertersTests =
    ...
    [<TestCase("Xamarin.Forms.Grid.IGridList<Xamarin.Forms.View>", "IViewElement list")>]
    [<TestCase("System.Collections.Generic.IList<Xamarin.Forms.Effect>", "IViewElement list")>]
    [<TestCase("System.Collections.Generic.IList<T>", "IViewElement list")>]
    [<TestCase("System.Collections.Generic.IList<Xamarin.Forms.Behavior>", "IViewElement list")>]
    [<TestCase("System.Collections.Generic.IList<Xamarin.Forms.Span>", "IViewElement list")>]
    [<TestCase("System.Collections.Generic.IList<Xamarin.Forms.MenuItem>", "IViewElement list")>]

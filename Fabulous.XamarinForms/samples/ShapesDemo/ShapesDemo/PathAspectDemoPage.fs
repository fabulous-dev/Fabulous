                ...
                View.StackLayout(
                    ...
                    children = [
                        ...
                        View.Path(
                            ...
                            height = 100.,
                            width = 100.,
                            data = Content.fromString path
                        )
                        View.Label(text = "Fill")
                        View.Path(
                            aspect = Stretch.Fill,
                            stroke = Color.Yellow,
                            fill = Color.Red,

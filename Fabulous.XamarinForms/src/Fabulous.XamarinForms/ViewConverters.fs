...
module Converters =
    ...
    let updateUseSafeArea _ (currValue: bool voption) (target: Xamarin.Forms.Page) =
        match currValue with
        | ValueSome useSafeArea -> Xamarin.Forms.PlatformConfiguration.iOSSpecific.Page.SetUseSafeArea(

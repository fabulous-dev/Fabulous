    ...
    type Fabulous.XamarinForms.View with
        ...
        static member inline PlotView
            (model: PlotModel, ?controller: PlotController,
             ...
             ?styleSheets, ?tabIndex, ?translationX, ?translationY, ?visual, ?width, ?style, ?styleClass, ?shellBackButtonBehavior,
            ...
            let attribs =
                ViewBuilders.BuildView(attribCount, ?gestureRecognizers=gestureRecognizers, ?horizontalOptions=horizontalOptions, ?margin=margin,
                                       ...
                                       ?style=style, ?styleClass=styleClass, ?shellBackButtonBehavior=shellBackButtonBehavior, ?shellBackgroundColor=shellBackgroundColor,

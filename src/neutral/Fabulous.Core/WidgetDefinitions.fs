...
type WidgetDefinition =
    { Key: WidgetKey
      Name: string
      TargetType: Type
      CreateView: Widget * EnvironmentContext * ViewTreeContext * IViewNode voption -> struct (IViewNode * obj)
      AttachView: Widget * EnvironmentContext * ViewTreeContext * IViewNode voption * obj -> IViewNode }

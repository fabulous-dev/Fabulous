...
Along with this control, we create the wrapper (like defined in the [View Extensions documentation](https://docs.fabulous.dev/v1/api/custom-renderer/Fabulous.XamarinForms/views-extending.html)) so we can use it in our Fabulous application:

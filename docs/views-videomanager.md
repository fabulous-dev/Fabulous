...
2. Next add a reference to `Fabulous.VideoManager` across your whole solution.
...
* [Source for the VideoManager extension](https://github.com/fsprojects/Fabulous/tree/master/extensions/VideoManager)
